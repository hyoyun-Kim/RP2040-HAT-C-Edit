...
- **timer**
  ...
  Such as here is a example code in the 'RP2040-HAC-C/examples/dhcp_dns/w5x00_dhcp_dns.c'. (You can modify the inside of the **repeating_timer_callback** function.)
